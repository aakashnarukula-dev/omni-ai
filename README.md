...
Omni splits one sentence into multiple items. A local rule-based classifier handles offline; a cloud-hosted Gemini model (through a Node proxy you own) handles the tricky ones. Each split card shows the kind (TASK / ALARM / NOTE), priority, tag, and inferred due time. Accept one, dismiss another, save the rest in one tap.
...
<p>
  <img src="docs/assets/screens/06-camera-debit.png" width="200" alt="Debit card scan" />
  <img src="docs/assets/screens/06-camera-pan.png" width="200" alt="PAN scan" />
  <img src="docs/assets/screens/06-camera-review.png" width="200" alt="Captured review" />
</p>
...
<img src="docs/assets/screens/00-design-system.png" width="520" alt="Design tokens" />
